    ...
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-2 sm:pt-10 border-t">
      ...
      <div className="min-w-60">
        ...
        >
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            <p className="flex gap-2">
              <input type="checkbox" className="w-3" value={"Topwear"} onChange={toogleSubCategory}/>{" "}
              Topwear
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3" value={"Bottomwear"} onChange={toogleSubCategory}/>{" "}
              Bottomwear
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3" value={"Winterwear"} onChange={toogleSubCategory}/>{" "}
              Winterwear
            </p>
          </div>
        </div>
